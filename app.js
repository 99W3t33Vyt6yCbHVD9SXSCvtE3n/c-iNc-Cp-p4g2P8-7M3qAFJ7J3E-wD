...
(function () {
  ...
  var TRANSITIONS = [
    { cls: "t-fade", duration: 3200 },
    { cls: "t-zoom-in", duration: 4000 },
    { cls: "t-zoom-out", duration: 4000 },
    { cls: "t-zoom-soft", duration: 5000 },
    { cls: "t-pan-left", duration: 4200 },
    { cls: "t-pan-right", duration: 4200 },
    { cls: "t-pan-up", duration: 4200 },
    { cls: "t-pan-down", duration: 4200 },
    { cls: "t-slide-left", duration: 3200 },
    { cls: "t-slide-right", duration: 3200 },
    { cls: "t-slide-up", duration: 3200 },
    { cls: "t-slide-down", duration: 3200 },
    { cls: "t-blur", duration: 3600 },
    { cls: "t-kenburns", duration: 5200 },
    { cls: "t-cross-zoom", duration: 4000 }
  ];
  ...
  var photoDurationMs = 6000;
  var lastPhotoDurationMs = 10000;
  ...
  function renderStep(instant) {
    ...
    if (step.type === "chapter-title") {
      ...
      if (instant) {
        // Navegación forzada: ningún efecto de entrada ni salida.
      ...
      // entrada de la foto nueva y se cambia después con crossfade.
      ...
      if (instant) {
        ...
        // La foto nueva ya está entrando. El fondo permanece con la foto
        // anterior y se actualiza después de la entrada + un retraso.
        var bgToken = ++backgroundTransitionToken;
        var bgDelay = transitionDuration + 1200;
        setTimeout(function () {
